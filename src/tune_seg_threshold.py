...
seg_thresholds = [0.55, 0.56, 0.57, 0.58, 0.59]
#seg_thresholds = [0.61, 0.62, 0.63, 0.64]
#seg_thresholds = [0.66, 0.67, 0.68, 0.69]
#seg_thresholds = [0.6, 0.65, 0.7, 0.75, 0.8]    # threshold to identify a pixel as positive.(originally 0.37)
level = 2
...
if __name__ == '__main__':
    ...
    for seg_threshold in seg_thresholds:
        print("seg threshold = ", seg_threshold)
        ...
        print('area error ((est - true) / true): ' + str((estimated_area - true_area) / true_area))
